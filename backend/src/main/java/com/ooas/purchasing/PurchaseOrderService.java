...
import com.ooas.purchasing.dto.UpdatePoStatusRequest;
...
public class PurchaseOrderService {
    ...
    @Transactional
    public List<PurchaseOrderResponse> generateFromRequest(String requestId, String userId) {
        ...
        List<PurchaseOrder> saved = purchaseOrderRepository.saveAll(purchaseOrders.values());
