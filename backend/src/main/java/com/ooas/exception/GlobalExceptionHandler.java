...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleApiException(ApiException ex, HttpServletRequest request) {
        return build(java.util.Objects.requireNonNull(ex.status()), ex.getMessage(), request.getRequestURI());
    }
    ...
    private ResponseEntity<ErrorResponse> build(@NonNull HttpStatus status, String message, String path) {
