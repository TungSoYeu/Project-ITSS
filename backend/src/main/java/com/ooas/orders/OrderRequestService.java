...
import com.ooas.catalog.CatalogService;
...
public class OrderRequestService {
    ...
    public OrderRequestService(OrderRequestRepository requestRepository, AuthService authService, CatalogService catalogService) {
    ...
    @Transactional
    public OrderRequestResponse create(OrderRequestUpsertRequest request, String userId) {
    ...
    private List<OrderRequestItem> toItems(OrderRequestUpsertRequest request) {
        return request.items().stream()
                .map(item -> new OrderRequestItem(
                        catalogService.requireSku(item.skuId()),
                        item.quantity(),
